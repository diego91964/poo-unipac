...
public class Computador {
	...
	public String toString() {
		return "Computador [cor=" + cor + ", modelo=" + modelo
				+ ", quantidadeDeProcessadores=" + quantidadeDeProcessadores
				+ ", quantidadeDeSlotsPci=" + quantidadeDeSlotsPci
				+ ", quantidadeDeSlotsSata=" + quantidadeDeSlotsSata
				+ ", larguraTela=" + larguraTela + ", alturaTela=" + alturaTela
				+ ", ligado=" + ligado + ", processador=" + processador
				+ ", memoria=" + memoria + "]";
	}
